...
echo "OPD_KL_MODE=${OPD_KL_MODE}, OPD_TOPK=${OPD_TOPK}, OPD_EXPLICIT_LOSS_COEF=${OPD_EXPLICIT_LOSS_COEF}, OPD_DISTILL_MAX_RESPONSE_LEN=${OPD_DISTILL_MAX_RESPONSE_LEN}, OPD_TOKEN_STATS=${OPD_TOKEN_STATS}"
...
CKPT_ARGS=(
   ...
   --save /root/slime_siqi/output/Qwen3-1.7B_8B_opd_noanswer_dapo/
   --save-interval 2000
)
# '''
