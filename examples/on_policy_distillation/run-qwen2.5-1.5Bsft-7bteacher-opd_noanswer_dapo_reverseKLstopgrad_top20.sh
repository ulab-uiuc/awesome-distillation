...
source "/root/slime_siqi/scripts/models/qwen2.5-math-1.5B.sh"
...
CKPT_ARGS=(
   ...
   --ref-load "/root/checkpoints_siqi/Qwen2.5-Math-1.5B-sftstep138_torch_dist"
...
WANDB_ARGS=(
   ...
   --wandb-group run-qwen2.5-1.5Bsft-7bteacher-opd_noanswer_dapo_reverseKLstopgrad_top20
