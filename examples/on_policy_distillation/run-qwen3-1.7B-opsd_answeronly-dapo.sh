...
CKPT_ARGS=(
   ...
   --save /root/slime_siqi/output/Qwen3-1.7B_opsd_answeronly_dapo/
   --save-interval 2000
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-1.7B-opsd_answeronly_dapo
...
RAY_JOB_ID="qwen3_1p7b_opsd_answeronly_dapo_$(date +%s)"
